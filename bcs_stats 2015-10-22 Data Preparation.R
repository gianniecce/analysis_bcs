...
# 2015-10-18 
# save(dta, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dta.RData')
load(file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dta.RData')
...
# save(dt, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/dt.RData')
n_distinct(dt$pid)
...
head(dataWide) 
# save(dataWide, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dataWide.RData') 
load(file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dataWide.RData')
...
dt_sub = distinct(select(dt, pid, SEX))
...
# save(dataWide2, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dataWide2.RData') 
load(file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dataWide2.RData')
...
library(TraMineR)
bc_seq = seqformat(bc, id = 'bcsid', begin = 'jstyr', end = 'jendyr', status = 'class', process = F, from = "SPELL", to = "STS", pvar = c("idpers")) 
nrow(bc_seq)
#
# save(bc_seq, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/bc_seq.RData')
load(file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/bc_seq.RData')
#  
...
# save(bcs70, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/bcs70.RData')
load(file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/bcs70.RData') 
...
# save(dataWide3, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dataWide3.RData')
...
load(file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/dt.RData')

n_distinct(dataWide3$pid)
n_distinct(dt$pid)

dta3 = dt[dt$pid %in% dataWide3$pid, ]

table(unique(dta3$pid) == dataWide3$pid) 

# save(dta3, file = '/Users/giacomovagni/Rprojects/analysis_bcs/data/2015_october_new/dta3.RData')
